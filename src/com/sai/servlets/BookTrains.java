...
import com.sai.beans.TrainBean;
import com.sai.beans.TrainException;
import com.sai.constant.ResponseCode;
import com.sai.constant.UserRole;
import com.sai.service.BookingService;
import com.sai.service.TrainService;
import com.sai.service.impl.BookingServiceImpl;
import com.sai.service.impl.TrainServiceImpl;
...
public class BookTrains extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			String dbDate = LocalDate.now().toString();
			String displayDate = dbDate;
			utilDate = inputFormat.parse(journeyDate);
			dbDate = inputFormat.format(utilDate);
			displayDate = displayFormat.format(utilDate);
				...
				if (seat > avail) {
					...
					if (ResponseCode.SUCCESS.toString().equalsIgnoreCase(responseCode)) {
						...
						pw.println("<div class='tab'>" + "<p class='menu'>" + "<table>"
								...
								+ "<tr><td>Date Of Journey:</td><td>" + displayDate
